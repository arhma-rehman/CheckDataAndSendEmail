...
import com.cr.email.GEmailSender;
import com.cr.email.JsonDataChecker;
import com.cr.email.JsonToExcelConverter;
        ...
        try {
            ...
            if (jsonData != null && !jsonData.isEmpty()) {
                ...
                if (excelFile != null) { // Check if file creation was successful
                    // Email details
                    String from = "xyz@gmail.com";//add the sender email here
                    String to = "abc@gmail.com";//add receiver's email here
